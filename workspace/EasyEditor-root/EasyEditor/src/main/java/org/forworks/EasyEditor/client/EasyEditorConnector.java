...
@Connect(EasyEditor.class)
public class EasyEditorConnector extends AbstractComponentConnector {

	// ServerRpc is used to send events to server. Communication implementation
	// is automatically created here
	EasyEditorServerRpc rpc = RpcProxy.create(EasyEditorServerRpc.class, this);

	public EasyEditorConnector() {
		
		// To receive RPC events from server, we register ClientRpc implementation 
		registerRpc(EasyEditorClientRpc.class, new EasyEditorClientRpc() {
	...
	protected Widget createWidget() {
		return GWT.create(EasyEditorWidget.class);
	}

	
	// We must implement getWidget() to cast to correct type
	@Override
	public EasyEditorWidget getWidget() {
		return (EasyEditorWidget) super.getWidget();
	}
